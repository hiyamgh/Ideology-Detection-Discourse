...
class ActivePassiveInputSchema(BaseIOSchema):
...
class ActivePassiveOutputSchema(BaseIOSchema):
...
agent_active_passive = BaseAgent(
    config=BaseAgentConfig(
        ...
        memory=memory,
        input_schema=ActivePassiveInputSchema,
        output_schema=ActivePassiveOutputSchema,
    ),
)
...
if __name__ == '__main__':
    ...
    initial_message = ActivePassiveInputSchema(chat_message="Hello! How can I assist you today?")
    ...
    while True:
        ...
        response = agent_active_passive.run(ActivePassiveInputSchema(
